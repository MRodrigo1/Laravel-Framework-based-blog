        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                ...
                <x-dropdown>
                    ...
                    {{--se o form quiser ser ativo, por esta classe e tirar do x-dropdown.. text-xs font-semibold text-blue-500 ml-6 --}}
                        ...
                        <div>
                            <input id="email" 
                                 ...
                                 name="email"
                                   ...
                                   @error('email')
                                        <span class="flex text-red-500 text-xs pt-5 px-5">{{ $message }}</span>
                                   @enderror
                            </div>
                        </div>
                        <button type="submit"
